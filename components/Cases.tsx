            ...
            <article className="case-row">
              <div className="case-thumb case-thumb--green">
                <div className="case-thumb__shots">
                  <img
              decoding="async"
              loading="lazy" className="case-thumb__shot case-thumb__shot--back-l" src="/next-assets/Trailmates-16.webp" alt="" width={462} height={1000} />
                  <img
              decoding="async"
              loading="lazy" className="case-thumb__shot case-thumb__shot--back-r" src="/next-assets/Trailmates-18.webp" alt="" width={462} height={1000} />
                  <img
              decoding="async"
              loading="lazy"
                    className="case-thumb__shot case-thumb__shot--front"
                    src="/next-assets/Trailmates-1.webp"
            ...
            <article className="case-row">
              <div className="case-thumb case-thumb--orange">
                <div className="case-thumb__shots">
                  <img
              decoding="async"
              loading="lazy" className="case-thumb__shot case-thumb__shot--back-l" src="/next-assets/Bingo-2.webp" alt="" width={462} height={1000} />
                  <img
              decoding="async"
              loading="lazy" className="case-thumb__shot case-thumb__shot--back-r" src="/next-assets/Bingo-3.webp" alt="" width={462} height={1000} />
                  <img
              decoding="async"
              loading="lazy"
                    className="case-thumb__shot case-thumb__shot--front"
                    src="/next-assets/Bingo-1.webp"
          ...
          <div className="cases__featured">
            <div className="case-thumb case-thumb--blue">
              <div className="case-thumb__shots">
                <img
              decoding="async"
              loading="lazy" className="case-thumb__shot case-thumb__shot--back-l" src="/next-assets/HotelOps-2.webp" alt="" width={462} height={1000} />
                <img
              decoding="async"
              loading="lazy" className="case-thumb__shot case-thumb__shot--back-r" src="/next-assets/HotelOps-1.webp" alt="" width={462} height={1000} />
                <img
              decoding="async"
              loading="lazy"
                  className="case-thumb__shot case-thumb__shot--front"
                  src="/next-assets/HotelOps-3.webp"
